...
export async function createInterview(
  ...
  if (
    ...
    throw new Error(
      "Only shortlisted applications can have an interview scheduled.",
    );
  }
  ...
  if (
    ...
    if (
      ...
      throw new Error(
        "The selected interviewer is inactive.",
      );
    }
    ...
    if (
      ...
      throw new Error(
        "The selected user cannot be assigned as an interviewer.",
      );
    }
  }
...
export async function updateInterviewStatus(
  ...
  return await db.transaction(async (tx) => {
    ...
    if (
      ...
      throw new Error(
        `Interview is already ${existing.status}.`,
      );
    }
    ...
    if (status === "completed") {
      ...
      if (!application) {
        throw new Error(
          "Application could not be moved to Hiring Decision.",
        );
      }
      ...
      if (
        ...
        throw new Error(
          `Application status update failed. Current status: ${application.status}`,
        );
      }
    }
