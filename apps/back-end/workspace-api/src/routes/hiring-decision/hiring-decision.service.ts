...
export async function moveApplicationToHiringDecision(
  applicationId: number,
) {
  /* -------------------------------------------------------
     1. FIND APPLICATION
  ...
  if (
    ...
    throw new Error(
      "Only applications on hold can be reviewed again.",
    );
  }
...
export async function markApplicationAsHired(
  ...
  if (
    ...
    throw new Error(
      "Only applications ready for hire can be marked as hired.",
    );
  }
