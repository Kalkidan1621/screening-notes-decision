...
const roleData = [
  {
    name: "SUPER_ADMIN",
    description:
      "Full access to the entire recruitment system",
  },
  {
    name: "ADMIN",
    description:
      "Manages users, jobs and recruitment operations",
  },
  {
    name: "RECRUITER",
    description:
      "Manages jobs, applications and candidate screening",
  },
  {
    name: "HIRING_MANAGER",
    description:
      "Reviews candidates and participates in hiring decisions",
  },
];
...
const permissionData = [
  ...
  },
  {
    ...
    description:
      "Create or update screening decisions",
  },
  {
    name: "screening.delete",
    description:
      "Delete screening information",
  },
