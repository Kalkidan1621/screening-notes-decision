...
--> statement-breakpoint
ALTER TABLE "applications" ADD COLUMN "candidate_id" integer NOT NULL;--> statement-breakpoint
...
ALTER TABLE "applications" ADD CONSTRAINT "unique_candidate_job" UNIQUE("candidate_id","job_id");