import { integer, boolean, pgTable, serial, varchar, text, timestamp, unique, } from "drizzle-orm/pg-core";
...
export const jobs = pgTable("jobs", {
    ...
    workingTime: varchar("working_time", {
        length: 100,
    }).notNull(),
    experience: varchar("experience", {
        length: 100,
    }).notNull(),
    educationalQualification: varchar("educational_qualification", {
        length: 255,
    }).notNull(),
    // Dates and salary
    openingDate: varchar("opening_date", {
        length: 50,
    }).notNull(),
    closingDate: varchar("closing_date", {
        length: 50,
    }).notNull(),
...
export const applications = pgTable("applications", {
    ...
    resumeName: varchar("resume_name", {
        length: 255,
    }).notNull(),
    ...
    uniqueCandidateJob: unique("unique_candidate_job").on(table.candidateId, table.jobId),
}));
