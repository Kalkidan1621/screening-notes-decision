...
import { createEmployerSchema, employerIdSchema, updateEmployerSchema, } from "./employer.schema.js";
import { createEmployer, deleteEmployer, getAllEmployers, getEmployerById, updateEmployer, } from "./employer.service.js";
...
employerRoutes.patch("/:id", async (c) => {
    try {
        ...
        const employer = await updateEmployer(idParsed.data.id, parsed.data);
        if (!employer) {
            return c.json({
                success: false,
                message: "Employer not found.",
